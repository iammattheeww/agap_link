    ...
    <div class="dashboard-container">
        ...
        <div class="report-modal-overlay" id="reportModal">
            <div class="report-modal">
                ...
                <p class="modal-subtitle">Help improve your community by reporting issues.</p>
        ...
        <main class="main-content page-transition">
            <header class="content-header">
                <div class="welcome-section">
                    <h1 class="welcome-title">Welcome back, <?= htmlspecialchars($firstName) ?>!</h1>
                    ...
                    <div class="reports-list-activity">
                        <?php foreach ($userReports as $report): ?>
                            <div class="activity-card">
                                <div class="activity-icon <?= strtolower($report['status']) === 'resolved' ? 'icon-success' : 'icon-pending' ?>">
                                    <?= strtolower($report['status']) === 'resolved' ? '✓' : '⏱' ?>
                                </div>
                                <div class="activity-content">
                                    <h3 class="activity-title"><?= htmlspecialchars($report['description']) ?></h3>
